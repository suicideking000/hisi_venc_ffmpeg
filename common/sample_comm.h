...
typedef enum hiSAMPLE_SNS_TYPE_E
{
    ...
    OV_OV9734_MIPI_1M_30FPS_10BIT_WDR2TO1,
    OV_OV2740_MIPI_2M_30FPS_10BIT,
    OV_OV2740_MIPI_2M_30FPS_10BIT_WDR2TO1,
    OV_OV6946_MIPI_160K_30FPS_10BIT,
    OV_OV6946_MIPI_160K_30FPS_10BIT_WDR2TO1,
    CV_CV8001_MIPI_8M_30FPS_12BIT,
    CV_CV8001_MIPI_8M_30FPS_12BIT_WDR2TO1,
...
/*test*/
typedef struct getchnframe_process_para
{
    VPSS_GRP VpssGr;
    VPSS_CHN VpssChn;
}getchnframe_process_s;
...
//temp
HI_S32 SAMPLE_COMM_REGION_AttachToChn_2(HI_S32 HandleNum,RGN_TYPE_E enType, MPP_CHN_S *pstMppChn,HI_S32 flag);
HI_S32 SAMPLE_Overlay_REGION_AttachToChn1(HI_S32 HandleNum,RGN_TYPE_E enType, MPP_CHN_S *pstMppChn);
HI_S32 SAMPLE_Overlay_REGION_AttachToChn2(HI_S32 HandleNum,RGN_TYPE_E enType, MPP_CHN_S *pstMppChn);
HI_S32 SAMPLE_COMM_REGION_SetBitMap1(RGN_HANDLE Handle);
#ifdef __cplusplus
#if __cplusplus
}
#endif
