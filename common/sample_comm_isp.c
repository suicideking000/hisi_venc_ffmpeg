...
ISP_PUB_ATTR_S ISP_PUB_ATTR_IMX290_MIPI_1M_30FPS_WDR2TO1_LINE =
{
    {0, 0, 1280, 720},
    {1280, 720},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_OV9734_1M_30FPS =
{
    {0, 0, 1280, 720},
    {1280, 720},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_OV9734_MIPI_1M_30FPS_WDR2TO1_LINE =
{
    {0, 0, 1280, 720},
    {1280, 720},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_OV2740_2M_30FPS =
{
    {0, 0, 1920, 1080},
    {1920, 1080},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_OV2740_MIPI_2M_30FPS_WDR2TO1_LINE =
{
    {0, 0, 1920, 1080},
    {1920, 1080},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_OV6946_160K_30FPS =
{
    {0, 0, 400, 400},
    {400, 400},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_OV6946_MIPI_160K_30FPS_WDR2TO1_LINE =
{
    {0, 0, 400, 400},
    {400, 400},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_CV8001_4K_30FPS =
{
    {0, 0, 3840, 2160},
    {3840, 2160},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_CV8001_4K_30FPS_WDR2TO1_LINE =
{
    {0, 0, 3840, 2160},
    {3840, 2160},
    30,
...
HI_S32 SAMPLE_COMM_ISP_GetIspAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S* pstPubAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX290_MIPI_1M_30FPS_12BIT_WDR2TO1:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_IMX290_MIPI_1M_30FPS_WDR2TO1_LINE, sizeof(ISP_PUB_ATTR_S));
            break;
        ...
        case OV_OV9734_MIPI_1M_30FPS_10BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_OV9734_1M_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;

        case OV_OV9734_MIPI_1M_30FPS_10BIT_WDR2TO1:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_OV9734_MIPI_1M_30FPS_WDR2TO1_LINE, sizeof(ISP_PUB_ATTR_S));
            break;

        case OV_OV2740_MIPI_2M_30FPS_10BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_OV2740_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;

        case OV_OV2740_MIPI_2M_30FPS_10BIT_WDR2TO1:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_OV2740_MIPI_2M_30FPS_WDR2TO1_LINE, sizeof(ISP_PUB_ATTR_S));
            break;

        case OV_OV6946_MIPI_160K_30FPS_10BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_OV6946_160K_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;

        case OV_OV6946_MIPI_160K_30FPS_10BIT_WDR2TO1:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_OV6946_MIPI_160K_30FPS_WDR2TO1_LINE, sizeof(ISP_PUB_ATTR_S));
            break;

	case CV_CV8001_MIPI_8M_30FPS_12BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_CV8001_4K_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;

        case CV_CV8001_MIPI_8M_30FPS_12BIT_WDR2TO1:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_CV8001_4K_30FPS_WDR2TO1_LINE, sizeof(ISP_PUB_ATTR_S));
            break;
...
ISP_SNS_OBJ_S* SAMPLE_COMM_ISP_GetSnsObj(HI_U32 u32SnsId)
{
    ...
    switch (enSnsType)
    {
        ...
        case CV_CV8001_MIPI_8M_30FPS_12BIT:
        case CV_CV8001_MIPI_8M_30FPS_12BIT_WDR2TO1:
            return &stSnsCv8001Obj;

        case OV_OV9734_MIPI_1M_30FPS_10BIT:
        case OV_OV9734_MIPI_1M_30FPS_10BIT_WDR2TO1:
            return &stSnsOv9734Obj;

        case OV_OV2740_MIPI_2M_30FPS_10BIT:
        case OV_OV2740_MIPI_2M_30FPS_10BIT_WDR2TO1:
            return &stSnsOv2740Obj;	

        case OV_OV6946_MIPI_160K_30FPS_10BIT:
        case OV_OV6946_MIPI_160K_30FPS_10BIT_WDR2TO1:
            return &stSnsOv6946Obj;	
